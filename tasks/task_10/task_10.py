    ...
    if 'question_bank' not in st.session_state or len(st.session_state['question_bank']) == 0:
        ...
        with screen.container():
            ...
            with st.form("Load Data to Chroma"):
                ...
                topic_input = st.text_input("Topic for quiz")
                number_questions = st.slider("Number of questions", min_value=1, max_value=10, value=5)
                ##### YOUR CODE HERE #####
                ...
                if submitted:
                    ...
                    if len(processor.pages) > 0:
                        st.write(f"Generating {number_questions} questions for topic: {topic_input}")
                    
                    ##### YOUR CODE HERE #####
                    generator = QuizGenerator(topic_input, number_questions, chroma_creator)
